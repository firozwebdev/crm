...
class Users_model extends CI_Model {
    ...
    function all(){
        $conQ = $this->db->query("select * from live_users order by id desc");
        return $conQ->result();
    }
  /*  function all()
    {
   ...
   /*function save()
    {
        ...
        if( $user_id ) :
            ...
            $contact_id = $this->contacts_model->save($user_id);
            return $contact_id;
        else:
...
*/
    ...
    function save($user_id)
    {
        ...
        if( $user_id ) {
            $this->account_model->update($user_id);
        }
    ...
    {
        $conQ = $this->db->query("select * from live_users where id = '$user_id'");
